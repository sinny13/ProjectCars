...
public class QnaController {
	...
	public String list(@RequestParam(defaultValue = "1") int viewPage, 
	...
	public String registerForm(@ModelAttribute("viewPage") int viewPage) {
	...
	public String modify(QnaVO qna, @ModelAttribute("viewPage") int viewPage, Model model) {
	...
	public String remove(@ModelAttribute QnaVO qvo, int viewPage, RedirectAttributes rttr) {
